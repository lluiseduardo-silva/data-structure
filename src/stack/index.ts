...
items.forEach(e => stack.acrescentar(e))
console.log('Numa pilha o primeiro item a entrar é o ultimo a sair')
console.log(`stack atual: ${stack.toString()}`);
console.log(`o proximo item da pilha é ${stack.obterProximo()}`);
console.log(`o proximo item da pilha foi removido e seu valor é ${stack.removerUltimoeRetornarEle()}`)
console.log(`o proximo item da pilha é : ${stack.obterProximo()}`);